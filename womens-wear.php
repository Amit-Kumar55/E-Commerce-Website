<title>Vpark Textile:Women's Wear</title>
    <!-- fonts -->
...
<div class="newest">
                <div class="container">
                    <center>
                    <h1 style="font-size:4rem;">Women's Wear</h1>
                    <hr>
                    </center>
                            ...
                            <ul id="myTab" class="nav nav-tabs newest" role="tablist">
                                <!-- <li role="presentation" class="active">
                                    <a href="#1" id="cat-1" role="tab" data-toggle="tab" aria-controls="1"
                                        aria-expanded="true">Featured</a>
                                </li>
                                <li role="presentation">
                                    <a href="#2" role="tab" id="cat-2" data-toggle="tab" aria-controls="2">New
                                        Arrivals</a>
                                </li> -->
                                <!-- <li role="presentation">
                                    <a href="#3" role="tab" id="cat-3" data-toggle="tab" aria-controls="3">Best
                                        Seller</a>
                                </li> -->
                            </ul>
                                ...
                                <div role="tabpanel" class="tab-pane fade in active" id="1" aria-labelledby="cat-1">
                                    <div class="row clearfix">
                                            ...
                                            <div class="product-fade">
                                                <div class="product-fade-wrap">
                                                    <div id="product-image" class="owl-carousel owl-theme">
                                                        <div class="item"><img src="https://5.imimg.com/data5/EO/SO/JQ/SELLER-50655871/j-b-fashion-women-s-ladies-top-500x500.jpg" alt="" class="img-responsive"></div>
                                        ...
                                        <div class="col-md-3 prdct-grid">
                                            <div class="product-fade">
                                                <div class="product-fade-wrap">
                                                    <div id="product-image2" class="owl-carousel owl-theme">
                                                        <div class="item"><img src="https://4.imimg.com/data4/IL/FL/MY-12847764/ladies-casual-denim-shirt-500x500.jpg" alt=""
                                                                class="img-responsive"></div>
                                                        <div class="item"><img src="images/p-3.jpg" alt=""
                                                                class="img-responsive"></div>
                                                        <div class="item"><img src="images/p-4.jpg" alt=""
                                            ...
                                            <div class="product-name">
                                                <a href="">Denim Shirt For Women</a>
                                            </div>
                                            <div class="star-1"></div>
                                            <div class="product-price">
                                                <span>$19.00</span> $15.00
                                            ...
                                            <div class="product-fade">
                                                <div class="product-fade-wrap">
                                                    <div id="product-image3" class="owl-carousel owl-theme">
                                                        <div class="item"><img src="https://5.imimg.com/data5/AE/IB/MY-56714701/ladies-printed-one-piece-dress-500x500.jpg" alt=""
                                                                class="img-responsive"></div>
                                                        <div class="item"><img src="images/p-4.jpg" alt=""
                                                                class="img-responsive"></div>
                                                        <div class="item"><img src="images/p-5.jpg" alt=""
                                            ...
                                            <div class="product-fade">
                                                <div class="product-fade-wrap">
                                                    <div id="product-image4" class="owl-carousel owl-theme">
                                                        <div class="item"><img src="https://assets.vogue.com/photos/61314d64598e49fed3cc1749/master/w_1280%2Cc_limit/slide_64.jpg" alt=""
                                                                class="img-responsive"></div>
                                                        <div class="item"><img src="images/p-5.jpg" alt=""
                                                                class="img-responsive"></div>
                                                        <div class="item"><img src="images/p-1.jpg" alt=""
